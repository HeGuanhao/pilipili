...
public class CodeGenerator {
    ...
    public void generator() {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/pilipili?useUnicode=true&useSSL=false&characterEncoding=utf8");
        // dsc.setSchemaName("public");
        dsc.setDriverName("com.mysql.jdbc.Driver");
        dsc.setUsername("root");
        dsc.setPassword("114514");
        mpg.setDataSource(dsc);

        // 包配置
        PackageConfig pc = new PackageConfig();
        //pc.setModuleName(scanner("模块名"));
        pc.setParent("com.igeek.hbut.shixi");
        ...
        strategy.setInclude(("user,video,comment,down,like,star,coin,admin,attention").split(","));
